...
namespace IS2.Database.ProjectData.Model
{
    ...
    /// Тип действия
    /// </summary>
    public class ActionType : VersioningEntity
    {
        #region Конструкторы
        ...
        public ActionType(Guid id, short actionTypeId, string name, Guid versionId, DateTime dateInsert, bool isDeleted) : base(id, versionId, dateInsert, isDeleted)
        {
