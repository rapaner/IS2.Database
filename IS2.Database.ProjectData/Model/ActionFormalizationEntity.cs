...
namespace IS2.Database.ProjectData.Model
{
    ...
    public class ActionFormalizationEntity : VersioningEntity
    {
        ...
        public ActionFormalizationEntity(Guid id, short actionFormalizationId, string name, Guid versionId, DateTime dateInsert, bool isDeleted) : base(id, versionId, dateInsert, isDeleted)
        {
